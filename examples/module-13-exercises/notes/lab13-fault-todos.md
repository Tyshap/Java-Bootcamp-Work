...
Fault code: Client/NotFound\
Fault string: Invalid Customer Id\
Detail customerId: CUS-9999\
Correlation id: lab-request-1\
HTTP/transport note (placeholder): Validation Fault\
Real hosting lab: lab13
