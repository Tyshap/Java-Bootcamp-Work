...
class CustomerServiceMockitoTest {
    ...
    void activatesProspectUsingStubbedRepository() {
        Customer ravi = new Customer(
                "CUS-1002", "Ravi Singh", "ravi.singh@example.com", "1234567890", CustomerStatus.PROSPECT, LocalDateTime.now());
    ...
    void addCustomerCapturesSavedEntity() {
        ...
        service.addCustomer(new Customer(
                "CUS-1001", "Amina Khan", "amina.khan@example.com", "1234567890", CustomerStatus.ACTIVE, LocalDateTime.now()));
