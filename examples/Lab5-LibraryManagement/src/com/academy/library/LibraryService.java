...
public class LibraryService {
    ...
    public void returnBook() {
        ...
        if (!borrowRecords.containsKey(bookId)) {
            System.out.println("Book not in borrow Records");
            return;
        }
        Iterator<Book> iterator = books.iterator();
        Book book = null;
        ...
        Iterator<BorrowRecord> borrowRecordIterator = borrowHistory.iterator();
        while (borrowRecordIterator.hasNext()) {
            BorrowRecord record = borrowRecordIterator.next();
    ...
    public void runPerformanceComparison() {
        ...
        System.out.printf("Array List 10,000 entries runtime: %.2f%n", duration);
        ...
        System.out.printf("Linked List 10,000 entries runtime: %.2f%n", duration);
